 ...
 *
 * ======================================================================== */
function arun_customize_register_scripts() {

	/* CSS */
	wp_register_style(
		'arun-customizer-sortable-checkboxes-css',
		get_template_directory_uri() . '/inc/customizer/assets/sortable-checkboxes.css'
	);
	wp_register_style(
		'arun-customizer-child-design-css',
		get_template_directory_uri() . '/inc/customizer/assets/child-design.css'
	);

	/* JS */
	wp_register_script(
		'arun-customizer-sortable-checkboxes-js',
...
add_action( 'customize_controls_enqueue_scripts', 'arun_customize_register_scripts', 0 );
/* ======================================================================== */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	class Arun_Sortable_Checkboxes_WPCC extends WP_Customize_Control {

		/**
		 * Scripts for this control
		 */
		public function enqueue() {
			wp_enqueue_style( 'arun-customizer-sortable-checkboxes-css' );
			wp_enqueue_script( 'arun-customizer-sortable-checkboxes-js' );
		}
		...
		public function render_content() {
			...
			?>
			<ul class="arun-sortable-checkboxes">
 ...
 * ======================================================================== */
if ( class_exists( 'WP_Customize_Control' ) ) {
	class Arun_Child_Design_WPCC extends WP_Customize_Control {

		public function enqueue() {
			wp_enqueue_style( 'arun-customizer-child-design-css' );
		}
		...
		public function render_content() {
			...
			?>
			<div class="arun-child-design" <?php $this->link(); ?>>
